...
const QuarterSetupTable = ({ fetchedData, setEdit, setFormData }) => {
    const [currentPage, setCurrenPage] = useState(1);
    const [startIndex, setStartIndex] = useState(0);
    const [endIndex, setEndIndex] = useState(5)

    const [deleteQuarter, { isError, isSuccess, error }] = useDeleteQuarterMutation();
...
export default QuarterSetupTable