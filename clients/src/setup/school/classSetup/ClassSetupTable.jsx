...
import { useDeleteClassMutation } from '../../../redux/API/setup/school/classSetupAPI';

// import { } from "@nextui-org/pagination";

const ClassSetupTable = ({ fetchedData, setEdit, setFormData }) => {
                ...
                <table className=" w-full  table-auto border-collapse border border-gray-300 text-left my-2 whitespace-nowrap">
                    <thead>
                        <tr className=' text-center'>
                            ...
                            <th className="  border border-gray-300 px-2 py-1">Class Id</th>
...
export default ClassSetupTable