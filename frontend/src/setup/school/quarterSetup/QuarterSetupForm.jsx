...
const QuarterSetupForm = ({  data, setData }) => {
    ...
    return (
        <div className=' flex flex-col justify-center my-2 items-center'>
            <h2 className='  heading'>Add/Edit Quarter Setup </h2>
            <form className=' bg-blue-100 p-6 ' onSubmit={handleSubmit}>

            <div className=' my-2'>
                    <label htmlFor='code' className='label'>Quarter Name:</label>
                ...
                <div className=' my-2'>
                    <label htmlFor='name' className='label'>Quarter Period:</label>
                ...
                <div className=' my-2'>
                    <label htmlFor='name' className='label'>Remarks</label>
                    <input id='name' name='name' type='text' className=' textinput' placeholder=""
                        value={data.feeName} onChange={(e) => setData({ ...data, feeName: e.target.value })} required />
                </div>
